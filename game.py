...
class player():
    ...
    def init_skills(self):
        # self.skills = {
        #     "strength": self.att["body"] * 2,
        #     "vigor": self.att["body"] * 2,
        ...
        #     "motor_skill": self.att["eyes"] * 2,
        #     "reaction": self.att["eyes"] * 2,
        ...
        #     "recall": self.att["mind"] * 2,
        #     "logic": self.att["mind"] * 2,
        #     "communication": self.att["mind"] + self.att["heart"],
        #     "persuasion": self.att["mind"] + self.att["heart"],
        #     "empathy": self.att["heart"] * 2,
        #     "willpower": self.att["heart"] * 2
        # }
        self.skills = {
            "strength": (self.att["body"] * 2) * 10,
            "vigor": (self.att["body"] * 2) * 10,
            ...
            "motor_skill": (self.att["eyes"] * 2) * 10,
            "reaction": (self.att["eyes"] * 2) * 10,
            ...
            "recall": (self.att["mind"] * 2) * 10,
            "logic": (self.att["mind"] * 2) * 10,
            "communication": (self.att["mind"] + self.att["heart"]) * 10,
            "persuasion": (self.att["mind"] + self.att["heart"]) * 10,
            "empathy": (self.att["heart"] * 2) * 10,
            "willpower": (self.att["heart"] * 2) * 10
        }
...
class game():
    ...
    def advance_course(self, course):
        print(f"Advancing course: {course['name']}")
    ...
    def advance_extracurricular(self, extracurricular):
        print(f"Advancing extracurricular: {extracurricular['name']}")
